...
class Home extends Component{
  ...
  <Mui.Toolbar >
    <Mui.Typography variant="h6">
      <img src="/dev.jpg" width="70" />
    </Mui.Typography>
    <form>
    <Mui.TextField width="300"
    ...
    <Mui.Button color="inherit" style={{marginLeft:650}}> <a href="/enter" class="crayons-btn crayons-btn--ghost-brand hidden mr-2 whitespace-nowrap s:block" data-no-instant>
          Log in
        </a></Mui.Button>
...
<br/>
<br/>
<a href="javascript:void(0)" class="crayons-link crayons-link--secondary crayons-link--block crayons-link--block--indented fs-s" id="main-nav-more-trigger"><font color="black">More...</font></a>
<br/>
...
<a href="https://dev.to/about" class="sidebar-navigation-link crayons-link crayons-link--block">
    <span class="crayons-icon crayons-icon--default" title="Listings">
      <svg viewBox="0 0 235 234" xmlns="http://www.w3.org/2000/svg" class="rainbow-logo" preserveAspectRatio="xMinYMin meet" width="23">
...
<a href="https://dev.to/terms" class="sidebar-navigation-link crayons-link crayons-link--block">
    ...
    <font color="black"> Terms of use</font>
  </a>
  <br/>
...
<div class="sidebar-nav-element" id="default-sidebar-element-tutorial">
          ...
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          <font color="black">#codenewbie</font>
          </a>
          </div>
          <br/>
          ...
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          <font color="black">#node</font>
          </a>
          </div>
          <br/>
          <div class="sidebar-nav-element" id="default-sidebar-element-android">
          <a class="crayons-link crayons-link--block py-2 px-2" href="/t">
          <font color="black">#android</font>
          </a>
          </div>
          <br/>
          <div class="sidebar-nav-element" id="default-sidebar-element-opensource">
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          <font color="black">#opensource</font>
          </a>
          </div>
          <br/>
          ...
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          <font color="black">#java</font>
          </a>
          </div>
          <br/>
          <div class="sidebar-nav-element" id="default-sidebar-element-showdev">
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          <font color="black">#showdev</font>
          </a>
          </div>
          <br/>
          ...
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          <font color="black">#aws</font>
          </a>
          </div>
          <br/>
          <div class="sidebar-nav-element" id="default-sidebar-element-php">
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          <font color="black">#php</font>
          </a>
          </div>
          <br/>
          <div class="sidebar-nav-element" id="default-sidebar-element-angular">
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          <font color="black">#angular</font>
          </a>
          </div>
          <br/>
          <div class="sidebar-nav-element" id="default-sidebar-element-typescript">
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          <font color="black">#typescript</font>
          </a>
          </div>
          <br/>
          <div class="sidebar-nav-element" id="default-sidebar-element-testing">
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          <font color="black">#testing</font>
          </a>
          </div>
          <br/>
          <div class="sidebar-nav-element" id="default-sidebar-element-linux">
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          <font color="black">#linux</font>
          </a>
          </div>
          <br/>
          <div class="sidebar-nav-element" id="default-sidebar-element-vue">
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          <font color="black">#vue</font>
          </a>
          </div>
          <br/>
          <div class="sidebar-nav-element" id="default-sidebar-element-help">
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          ...
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          <font color="black">#security</font>
          </a>
          </div>
          <br/>
          <div class="sidebar-nav-element" id="default-sidebar-element-ruby">
          <a class="crayons-link crayons-link--block py-2 px-2" href="/">
          <font color="black">#ruby</font>
          </a>
          </div>          
            </nav>
                        </p>
          ...
          <nav class="crayons-tabs hidden s:flex">
            ...
            <a href="/top/month" class="crayons-tabs__item ">Month</a>
            <a href="/top/year" class="crayons-tabs__item ">Year</a>
            <a href="/top/infinity" class="crayons-tabs__item ">Infinity</a>

            <a href="/latest" class="crayons-tabs__item ">Latest</a>
          </nav>
        ...
        <br/>
        <br/>
        <img src="/div.png" width="60" />
          <h2><a href="/">DEV</a> is a community of 508,432 amazing <br/> developers </h2>
        
          <p>We're a place where coders share, stay up-to-date and grow their careers. </p>
         <Mui.Button variant="contained" color="primary" style={{width:300}}  >
          Create New account
        </Mui.Button>
        <br/>
        <Mui.Button color="inherit" style={{textAlign:"Center"}}> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/" class="crayons-btn crayons-btn--ghost-brand hidden mr-2 whitespace-nowrap s:block" data-no-instant>
          Log in
        </a></Mui.Button>
        ...
        <Mui.Paper>
        <Mui.Grid item  xs={2}>
        <img src="/news.jpeg" width="150" />
         </Mui.Grid>   
        <Mui.Grid item  xs={2}>
        <h3>Listen to the <br/>DevNews Podcast</h3>
        </Mui.Grid>
        </Mui.Paper>
        </Mui.Paper>    
        </Mui.Grid>
